...
public class CustomerDAOImpl extends BaseDAO implements CustomerDAO {
    ...
    public void insert(Connection con, Customer cus) {
        ...
        try {
            BaseDAO.update(con,sql,cus.getName(),cus.getEmail(),cus.getBirth());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void update(Connection con, Customer cus) {
        ...
        try {
            BaseDAO.update(con,sql,cus.getName(),cus.getEmail(),cus.getBirth(),cus.getId());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public Customer getCustomerById(Connection con, int id) {
        ...
        Customer cust = BaseDAO.getInstance(con, Customer.class, sql, id);
        return cust;
    }
    ...
    public List<Customer> getAll(Connection con) {
        ...
        List<Customer> customers = BaseDAO.QueryForGeneralTable(con, Customer.class, sql);
        return customers;
    }
